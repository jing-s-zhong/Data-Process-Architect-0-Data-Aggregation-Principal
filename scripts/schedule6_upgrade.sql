...
-------------------------------------------------------
-- Upgrade aggregator stored procedures
-------------------------------------------------------
--
...
--
ALTER PROCEDURE IF EXISTS DATA_AGGREGATOR(STRING, BOOLEAN) RENAME TO _BKBY_&{ver}_DATA_AGGREGATOR;
CREATE PROCEDURE DATA_AGGREGATOR (
	TARGET_TABLE STRING,
	SCRIPT_ONLY BOOLEAN
	)
